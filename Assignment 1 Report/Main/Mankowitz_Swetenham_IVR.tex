...
An incorrect direction is defined as an arrow pointing at least $45^{\circ}$ away, in either direction, from the central vertex of the robot's arrowhead. The  algorithm is unable to detect that the arrow is pointing in an incorrect direction. This is shown in \figref{fig:missIncorrect}.
