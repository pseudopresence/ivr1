...
An example of an incorrect detection of a robot due to the robot leaving the image frame is shown in Figure~\ref{fig:InDetectData2}.
\begin{figure}[h!]
...
An example of an incorrect detection of a robot due to a region of highly saturated pixels that have a similar colour to that of the robot is shown in Figure~\ref{fig:InDetectData7}.
